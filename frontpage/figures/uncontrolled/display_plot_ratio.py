...
def do_plot_time(files_list, param):
    ...
    ax2.set_title('Comp vs Net Fraction in PLT', fontsize=8)
    ax2.set_xlabel('Ratio')
    ax2.set_ylabel('CDF')
    line_1.set_label('comp-uncontrolled')
    #line_2.set_label('comp-b20-d50')
    #line_3.set_label('comp-b20-d150')
    line_4.set_label('net-uncontrolled')
    ...
    plt.show()
    plt.savefig('../plots/ratio/new/' + 'mobile_uncontrolled'  + ".pdf")
    plt.close()
