...
def do_plot_time(files_list, param):
    ...
    plt.show()
    plt.savefig('../plots/ratio/' + 'mobile_desktop_plt_ratio_uncontrolled'  + ".pdf")
    plt.close()
...
def main():
    ...
    #file_list.append('desktop_wifi-b5-d5_mixed200_orig_minification.bench')
    #file_list.append('desktop_wifi-b5-d50_mixed200_orig_minification.bench')
    file_list.append('data_desktop_unlimited.bench')
    #file_list.append('desktop_wifi-b20-d50_mixed200_orig_minification.bench')
    #file_list.append('mobile_wifi-b1-d5_mixed200_orig_minification.bench')
    file_list.append('data_mobile_s4_unlimited.bench')
    #file_list.append('mobile_wifi-b5-d50_mixed200_orig_minification.bench')
    #file_list.append('mobile_wifi-b20-d5_mixed200_orig_minification.bench')
    #file_list.append('mobile_wifi-b20-d50_mixed200_orig_minification.bench')
