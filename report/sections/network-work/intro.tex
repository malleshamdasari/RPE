...
% Goal to understand application QoE, enterprise wireless networks want to manage their resources effectively
% Several recent work have looked at building QoS to QoE mapping for specific applications
% Limited to applications which can provide accurate ground truth for labeling 
