...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{sections/vlc-fps}
   \vspace{-0.1in}
...
\begin{minipage}[t]{.33\textwidth}
   \includegraphics[width=\linewidth]{sections/skype-fps.pdf}
...
\hspace{0.1in}
\begin{minipage}[t]{.33\textwidth}
   \includegraphics[width=\linewidth]{sections/skype-call-setup.pdf}
...
\hspace{0.1in}
\begin{minipage}[t]{.33\textwidth}
   \includegraphics[width=\linewidth]{sections/skype-bitrate.pdf}
