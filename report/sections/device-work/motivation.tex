...
\begin{figure*}[t]
     \subfloat[Clock]{%
       \includegraphics[width=0.33\textwidth]{sections/clock-device}
     }
     \subfloat[Memory]{%
       \includegraphics[width=0.33\textwidth]{sections/plt-memory}
     }
     \subfloat[GPU]{%
       \includegraphics[width=0.33\textwidth]{sections/plt-gpu}
     }
     \vspace{-0.1in}
