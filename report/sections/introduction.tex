...
However, with the advent of heterogeneous devices and networks, it has become difficult to uncover if a user is having QoE issues and find the root cuase of any issue. 
...
Also, the smartphone manufacturerers does not consider the QoE of applications while enhancing the device parameters.
